...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("Logs/Token_Train_Neurotoxine.log", encoding='utf-8'),
...
PATIENCE_ES = 15
PATIENCE_LR = 8
NPY_PATH = 'dataset_train_esm2_t33_650M_Neurotoxin_token_level.npy'
MODEL_PATH = 'ModelCNN_PROTEOGEN_V3/Neurotoxine_PROTEOGEN_model.keras'
...
dataset = pd.read_excel('Train_Neurotoxin.xlsx', na_filter=False)
...
def build_cnn(input_shape=(MAX_LEN, 1280)):
    ...
    return Model(inputs=inp, outputs=x, name='ESM_CNN_Neurotoxin')
